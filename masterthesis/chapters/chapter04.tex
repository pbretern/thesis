...
\begin{table}[H]
    ...
    \begin{tabular}{lp{15cm}c}
       ...
       \midrule
        ...
        F14                              &Das System erstellt bedarfsorientiert eine PDF mit den relevanten \textit{\acrshort{KPI}}. & M\\
        F15                              &Das System speichert das PDF-Dokument. & C\\
        F16                              &Das System speichert bedarfsorientiert Diagramme der relevanten \textit{\acrshort{KPI}} als Bilder. & C\\
