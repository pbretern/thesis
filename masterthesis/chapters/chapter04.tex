...
\begin{table}[h]
    ...
    \begin{tabular}{lp{15cm}c}
       ...
       \midrule
        ...
        F11                              &Das System analysiert die Daten automatisch nach deskriptiven und explorativen Methoden der Statistik.  & M\\
        F12                              &Das System filtert die Daten nach bestimmten Kriterien.  & M\\ %Filterkriterien sind in Tabelle aufgeführt.
        ...
        F14                              &Das System analysiert die gefilterten Daten automatisch nach deskriptiven und explorativen Methoden der Statistik. & M\\                             
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption{%
...
\begin{table}[h]
    ...
    \begin{tabular}{lp{15cm}c}
       ...
       \midrule
        ...
        F15                              &Das System speichert bedarfsorientiert Diagramme der relevanten \textit{\acrshort{KPI}} in einem platzsparenden Bildformat. & C\\
    ...
    \begin{tabular}{lp{7.5cm}p{7.5cm}}
       ...
       \midrule
        ...
        Inhalt                           &Die Bibliotheksleitung oder die Bibliotheksmitarbeiter:innen lassen sich auf der \textit{\acrshort{GUI}} die Ausleihzahlen pro Jahr anzeigen. & Das System filtert die betreffenden Datensätze nach Jahr. Das System zeigt diese Datensätze mit Datenvisualisierungen an.\\
                                         ...
                                         & &Das System zeigt darüberhinaus die Ausleihen pro Jahr und für den Gesamtzeitraum\footnotemark im Vergleich zum Bestandswachstum an.\\
        ...
        %Ausnahmeverhalten               &- &- \\
        Anforderungen                   &R1, R4, F2, F7-F12, NF14-NF18& -\\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption{%
...
\begin{table}[h]
    ...
    \begin{tabular}{lp{7.0cm}p{7.0cm}}
       ...
       \midrule
        ...
        %Ausnahmeverhalten               &- & -\\
        %Nachbedingungen                 &-& -\\
        Anforderungen                   &R2, R4, F2, F7-F12, NF9, NF14-NF18& -\\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption{%
...
\begin{table}[h]
    ...
    \begin{tabular}{lp{7.0cm}p{7.0cm}}
       ...
       \midrule
        ...
        Anforderungen                   &R1, R4, F2, F7-F12, NF9, NF14-NF18& -\\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption{%
...
\begin{table}[h]
    ...
    \begin{tabular}{lp{7.0cm}p{7.0cm}}
       ...
       \midrule
        ...
        Anforderungen                   &R1, R4, F2, F7-F13, NF9, NF14-NF18& -\\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption{%
...
\begin{table}[h]
    ...
    \begin{tabular}{lp{7.0cm}p{7.0cm}}
       ...
       \midrule
        ...
        Anforderungen                   &R1, R2, F14-F17, NF14-NF18& -\\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption{%
