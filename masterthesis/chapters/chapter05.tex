...
\section{Demonstration der Funktionalität}
    ...
    \begin{figure}[H]
        \centering
            \includegraphics[width=15cm, height=17.8cm]{tab1}
            \caption{Tab1}
            \label{fig:tab1}
    \end{figure}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.1\textwidth}p{0.5\textwidth}p{0.4\textwidth}p{0.3\textwidth}p{0.4\textwidth}p{0.4\textwidth}}
           ...
           \midrule
            ...
            \midrule
            3           &Jährliche Ausleihe nach den Top 10 RVK-Fachsys-tematiken mit Sonstige&Die 9 \textit{\acrshort{RVK}}-Fachsys-tematiken, bei denen die Ausleihanzahl am größten ist werden dargestellt. Die übrigen Fachsystematiken im Bestand werden in der Kategorie Sonstiges gruppiert.&Ausleihdaten&gestapeltes Balkendiagramm (horizontal)&Plotly-Interaktivität (Aus- und Einblenden von Balken, Hover-Informationen)\\
...
Das betrifft zum Beispiel die Vielzahl an Lieferanten\footenote{in den Originaldaten} in dem Diagramm \enquote{Gesamtumsatz Lieferant nach Jahren} im Tab \textit{Umsatz und Budget}. 
...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           Das System zeigt die Verteilung der ausgeliehenen Titel in der \textit{\acrshort{RVK}}-Fachsys-tematiken pro Jahr an.&Ausleihe Top RVK-Fachsys-tematiken mit
...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           \midrule
           Das System filtert die betreffenden Datensätze nach Jahr. Das System zeigt diese Datensätze mit Datenvisualisierungen an.&-&Durch die Teilsysteme 2  und 3 gewährleistet.\\
           Das System zeigt die Nutzung des Lesesaals nach Monat und Jahr, gruppiert in vier Service-Zeiten an.&Monatliche Anzahl der Nutzer:innen nach Servicezeiten& Die Jahre können im Dropdown-Menü im Frontend ausgewählt werden.\\
...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           Das System zeigt das Budget über den Gesamtzeitraum pro Kostenstelle an.&Budgetkosten Top 5 Kostenstellen mit Sonstige (Gesamtzeitraum), Gesamtbudget Kostenstellen nach Jahren&-\\
