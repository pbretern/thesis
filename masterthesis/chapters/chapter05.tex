...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           Das System zeigt die ausleihstärksten Titel absteigend nach Anzahl und Jahr an.&Jährliche Ausleihe nach den Top 10 RVK-Fachsys-tematiken mit Sonstige& Die Anzahl der \textit{\acrshort{RVK}}-Fachsystematiken kann im Programmcode beim Methodenaufruf als Parameter eingestellt werden.\\
           Das System zeigt die Verteilung der ausgeliehenen Titel in der \textit{\acrshort{RVK}}-Fachsys-tematiken pro Jahr an.& Tabellarische Darstellung der 5 besonders nachgefragten Titel nach Jahren&Die Anzahl der Titel kann im Programmcode beim Methodenaufruf als Parameter eingestellt werden.\\
