...
\section{Implementierung}
    ...
    und auf ihn dann die Methode \texttt{total\_expnd\_net\_years()} ausgeführt und den Dataframe als Ergebnis einer
    ...
    (2) In der \texttt{fig\_}-Funktion, die das Plotly Graph Object Figure erzeugt, werden die durch die Methoden der Kindklassen bearbeiteten Objekte (Dataframes, Series) 
    ...
    (3) Die \texttt{fig\_()}-Funktionen werden durch die Graph-Komponente der \texttt{dash\_core\_components} innerhalb der 
    ...
    (4) Die \texttt{html\_()}-Funktionen werden schließlich in einer Layoutfunktion eingebunden, die alle Funktionen dieser Art
...
\section{Demonstration der Funktionalität}
    ...
    tabellarisch dargestellt, wobei die tabellarische Darstellung sich an den Rows der Layout-Struktur richtet. 
