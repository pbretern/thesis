...
\section{Design}
    ...
    Python ist weitverbreitet, gut lesbar und gut dokumentiert.(Nachweis) Genutzt wurde für den Datenimport und die Datenbearbeitung insbesondere die Python-Bibliothek 
    ...
    Eine Pandas Series ist ein eindimensionales Array.\footnote Auf dem Dataframe, das als sogenannter Container für
    die geladenen Daten aus vielen Datenformaten dient, können verschiedene Operationen der Datenanalyse und -manipulation erfolgen.
    Ähnlicher wie bei SQL-Abfragen einer Datenbank lassen sich verschiedene wie Funktionen wie groupby() oder sort() Operationen wie mean() median() ausführen.
    Auch gibt es eine Vielzahl von Funktionen, um schnell einen Überblick über die vorliegenden Daten zu gewinnen.\\
    Bild einfaches Dataframe und Series\\
