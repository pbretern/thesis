...
\section{Implementierung}
    ...
    \textit{Teilsystem 1} ist für die erste Bereinigung der Daten und den Import der Daten in ein einheitliches Datenformat verantwortlich. 
    \textit{Teilsystem 2} greift auf den Speicherort der importierten Dateien zu und bereitet die Daten für die Anzeige im Dashboard vor, 
    indem es mit der Python-Bibliothek pandas Daten vorfiltert, gruppiert und Berechnungen auf den Daten ausführt. \textit{Teilsystem 3} ist für das Layout des Dashboards, 
    ...
    verantwortlich. \textit{Teilsystem 1} und \textit{Teilsystem 2} wurden versucht objektorientiert zu programmieren, da hier der Anspruch bestand, den Programmcode
    für verschiedene Daten wiederzuverwenden. \textit{Teilsystem 3} besteht vorerst nur aus Funktionen, die die Anzeige im Frontend ermöglichen.
    ...
    Zu diesem Zweck liegt eine csv-Datei der \textit{\acrshort{RVK}} zu Grunde, die mit einem Python-Skript aus einer \textit{\acrshort{RVK}}-XML-Datei entstanden ist.
    ...
    Diese wird bei jedem Aufruf der Methode mit den Werten der neu entstanden Spalte gemappt. Die Benennungen werden ebenfalls in je einer Spaltte gespeichert.
