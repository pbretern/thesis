...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           Das System zeigt die Anzahl der Titel nach Medienart an.&-&Diese Anforderung wurde zwar im Programmcode implementiert, aber nicht im Dashboard umgesetzt, da das gedruckte Buch als Medium dominiert und in der Anzahl zu wenige andere Medienarten in der Bibliothek vertreten sind.\\
...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           Das System zeigt die Anzahl der Titel nach Medienart an.&-&Diese Anforderung wurde zwar im Teilsystem 2 implementiert, aber wird nicht als Diagramm im Dashboard gezeigt, da zu wenig Medienarten in der Bibliothek vertreten sind und das gedruckte Buch überwiegt und in der Anzahl zu wenige andere Medienarten in der Bibliothek vertreten sind.\\
...
\begingroup
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{0.4\textwidth}p{0.5\textwidth}p{0.7\textwidth}}
           ...
           Das System zeigt die umsatzstärksen Lieferanten im Gesamtzeitraum an.&Top 10 Lieferanten mit Sonstige  &Die Anzahl der Lieferanten kann im Programmcode der Datei \texttt{expenditures\_tab.py} beim Methodenaufruf als Parameter eingestellt werden.\\
