            ...
            \begin{table}[h]
                ...
                \begin{tabular}{lccl}
                  %\begin{tabular}{p{3cm}p{5cm}p{1cm}p{1.5cm}p{2cm}p{4cm}}
                   ...
                   \midrule     
                        Import               &Import und erste Bereinigung der Daten aus heterogenen Datenquellen.\\
                        Datenbearbeitung     &Aufbereitung der Daten für die graphische Darstellung im Dashboard.\\
                        Darstellung          &Umwandlung der Daten in Datenvisualisierungen, etc. und Anzeige im Dashboard.\\
...
g
    ...
    Teilsystems 2 hat als Ziel die Daten für die Darstellung im Dashboard vorzubereiten. Der weitere Zweck dieses
    ...
    Basisklasse von der vier Kindklassen erben. Es gibt Kindklassen für Umsatz und Budget-Daten, für Bestands- und Neuerwerbungsdaten, für die Ausleihe-Daten und 
    ...
    (2) Das Ergebnis der Manipulation der pandas Dataframes ist auf die Darstellung der Daten Dashboard ausgerichtet. Als Input der Methoden werden verschiedene
    ...
    die Gesamtbudgetkosten für das laufende Jahr. Sie liefert eine Gleitkommazahl als Ergebnis zurück.
    Als Input erwartet die Methode den Namen der Datumspalte und den Namen der Umsatz/Budget-Spalte. Der Transformationsprozess teilt sich
