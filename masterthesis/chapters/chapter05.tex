...
\section{Implementierung}
    ...
    annehmen. Zum Beispiel können die Datumswerte der Spalte \enquote{Datum} in Datetimeformat-Objekte umgewandelt werden.
    ...
    Teilsystem 1 ist für die erste Bereinigung der Daten und den Import der Daten in ein einheitliches Dateiformat verantwortlich. 
    ...
    indem es mit der Python-Bibliothek pandas Daten vorfiltert, gruppiert und Berechnungen auf den Daten ausführt und auch Datenanreicherungen vollführt. Teilsystem 3 ist für das Layout des Dashboards, 
    ...
    Ferner werden erste Bereinigungen der Daten wie zum Beispiel das Entfernen unnötiger Zeichen durchgeführt. Die Daten werden zum Abschluss im csv-Format abgespeichert. Mit dem Teilsystem soll eine einheitliche Datengrundlage für die spätere 
    ...
    die diese Datenformate parsen können. Der Parser leitet die Datentypen der Werte in den Spalten
    ...
    %\begin{figure}[H]
        \centering
            \includegraphics[width=23cm, height=7cm]{data_prep}
...
Den Tab \textit{Lesesaal und Ausleihe} zeigt \autoref{fig:tab2}.
    ...
    \begin{figure}[H]
        \centering
            \includegraphics[width=16cm, height=18cm]{tab2}
            \caption{Tab2}
            \label{fig:tab2}
    \end{figure}
...
In dem vorliegenden Projekt wurden hauptsächlich die Bibliotheksdaten aus dem hebis-Verbund sowie aus dem \textit{\acrlong{LBS}} verarbeitet.
...
Des Weiteren wird bei dem monatlichen Abzug der Neuerwerbungsdaten aus dem \textit{\acrlong{CBS}} Duplikate mit exportiert. Diese Duplikate entstehen durch
