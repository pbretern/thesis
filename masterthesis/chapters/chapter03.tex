...
Über den integrierten Geschäftsgang der Medienerwerbung und -erschließung wird die klassische Basisfunktion Sammeln- und Erschließen erfüllt. 
...
\begin{figure}[h]
    \centering
        ...
        \includegraphics[width=6.5cm, height=9.0cm]{umsatzuebersicht_mtl}
...
oder nur unzureichend statt. Auch wird das Potential hinsichtlich der Budgetplanung wie in \autoref{chap:two_one} beschrieben
nicht ausgeschöpft.
