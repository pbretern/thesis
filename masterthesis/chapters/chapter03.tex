...
im Lokalsystem \textit{\acrfull{LBS}} von \acrshort{OCLC} statt. Im \textit{\acrfull{OPAC}} befinden sich Bücher, ausgewählte E-Books 
...
Die \textit{\acrfull{COP 5}} der Verlage werden auf einen internen Portal von der \acrshort{mpdl} für das Institut zur Verfügung gestellt.
