...
\label{chap:three}
Im folgenden Kapitel wird die wissenschaftliche Spezialbibliothek des \textit{\acrlong{MPI EA}} porträtiert, um die Ausgangslage zu umreißen.
...
welche statistischen Daten aggregiert und ausgewertet wurden. Diese Daten stellen die Basis für die Konzeption und Entwicklung eines datengetriebenen Unterstützungssystems dar.
...
empirischer Fragestellungen der Ästhetik. Das Institut besteht aus derzeit drei Abteilungen \textit{Sprache und Literatur}, 
...
Format die Daten vorliegen, über die Quellen aus der sie stammen und ob die Daten bereits systematisch ausgewertet und/oder visualisiert werden.
...
Springer, Wiley oder De Gruyter. Bisher wurden diese von der Bibliothek noch nicht gesichtet und ausgewertet.
