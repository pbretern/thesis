...
ACQ-Jahresübergang variiert und der Zeitpunkt wird von der Bibliothek vereinbart mit dem Lokalsystem-Team. Der Jahresübergang geschieht meistens in den ersten beiden Januarwochen des Jahres.}
...
\autoref{fig:budget- und umsatzuebersicht} zeigt ein Beispiel\footnote{Die Zahlen wurden zurückgesetzt.} vom November 2020 für die Budget- und Umsatzübersichten des Monats Oktober 2020, die vom Lokalsystem-Team als email zur Verfügung gestellt werden.


\begin{figure}[h]
    \centering
        \includegraphics[width=6.5cm, height=7.0cm]{budget_uebersicht_mtl}
