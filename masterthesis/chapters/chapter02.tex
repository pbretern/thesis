...
Datenvisualisierungen hingegen ist die Anzeige von Daten, die Analyse, Exploration und Entdeckung ermöglichen soll. Sie sollen das Verständnis der dargestellten Daten erleichtern
...
\cite[Vgl.][31]{cairo_truthful_2016}. % -> Sind Daten dargestellt > Exploration der Daten
...
erreicht werden soll. Des weiteren ist zu klären, wie groß die Datenmenge ist. Datentypen \textit{„...define the nature of the values held under each variable and about each item 
in your dataset.”} \cite[99]{kirk_data_2019} Diese können nominal, ordinal, intervall oder Verhältnis sein. Nominale und Ordinale Datentypen 
...
deskriptiv -> beschreibend Daten darstellen durch Datenvisualisierungen zum Zweck der Exploration der Daten
explorative 
