...
\label{chap:two_two}
Datenvisualisierungen sind wirkmächtig. Sie unterlegen Daten mit visuellen Reizen, die vom menschliche Auge schnell aufgenommen und vom
menschlichen Gehirn verarbeitet werden können \cite[Vgl.][32]{few_now_2009}. Zusammenhänge, Trends und Ausnahmen sind in einer Tabelle mit einer großen Datenmenge schwer zu lesen. Mit
Datenvisualisierungen fällt es hingegen einfacher diese darzustellen und schneller begreifbar zu machen. Dies ist ein großer Vorteil gegenüber
schwer lesbaren Zahlenkolonnen, in denen Zusammenhänge erarbeitet werden müssen.
Datenvisualisierungen stellen einen Weg da, statistische Informationen effizient zu kommunizieren \cite[Vgl.][15]{Tufte01}.
...
%Machine Learning The introduction of computers changed how you can analyze and explore data. You can make a lot of charts in a few seconds, view data from many angles, 
...
%Visualisierungen benötigen Daten - Daten benötigen Visualisierungen um den Wert der Daten besser präsentieren zu können.

Datenvisualisierungen sind Bestandteil der deskriptiven und explorativen Statistik oder Datenanalyse.
...
nennt fünf Eigenschaften: \textquote{truthful, functional, beautiful, insightful, enlightening}.
...
% Datentyp
Für die zum Einsatz kommenden Datenvisualisierungen sind die unterschiedlichen Datentypen von großer Relevanz.
...
Manchmal ist auch nur die Unterscheidung zwischen nominalen, ordinalen und metrischen
Merkmalen in der wissenschaftlichen Literatur anzutreffen \cite[Vgl.][20]{cleff_deskriptive_2011}. Unter Berücksichtigung der großen Bandbreite (variety) an Daten, schlägt \Citeauthor{kirk_data_2019} ferner eine Erweiterung der \acrshort{NOIR}-Systematik um einen textuellen Datentyp
...
%So ist die Raumtemperatur ein stetiges Merkmal.
%Für qualitative Merkmale eigen sich Balkendiagramme
...
Bei größer werdenden Datenmengen reichen Tabellen aber nicht mehr aus. Deswegen können Diagramme wie Balken -oder Liniendiagramme zum Einsatz kommen. 

Schließlich ist zu bestimmen, wie die Daten der Datenmenge in Verbindung zueinander stehen \dots
