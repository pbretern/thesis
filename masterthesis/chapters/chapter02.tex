...
Die Datenintegration in das \textit{\acrlong{DWH}} kann auf Grundlage eines multidimensionalen Datenmodells wie Datenwürfeln (data cubes) erfolgen. Ein \textit{\acrshort{DWH}} kann nach einem Datenwürfel (data cube) konzeptuell modelliert.
...
sind numerische Größen wie Gewinne und Erlöse. 
%Die Kennzahlen sind in den Zellen des Würfels enthalten.
Dimensionen sind Entitäten, die um einen Fakt angeordnet sind. Die Dimensionen spannen die Kanten des Datenwürfels auf.
Die Anzahl der Kanten entspricht der Dimensionalität eines Würfels.
Die Betrachtung der Kennzahlen ist so in einem multidimensionalen Datenmodell aus verschiedenen Dimensionen möglich.
...
Physisch realisiert werden kann dies mit einer logischen Datenmodellierung durch ein Star- oder Snowflake-Schema \cite[vgl.][177 f.]{linden_geschaftsmodellbasierte_2016}.
...
deren Aggregation möglich. Darüberhinaus können Teilmengen durch Slicing und Dicing gebildet werden. Durch OLAP-Anwendungen können die multidimensionale Datenstrukturen interaktiv ausgewertet werden.
...
Tabellen, Listen und Diagramme verwendet. Der Bericht kann bereitgestellt werden in Formaten wie PDF oder HTML \cite[vgl.][168, 176]{taschner_management_2013}
