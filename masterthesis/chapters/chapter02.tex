...
Anwendungssystemen wie \acrfull{OLTP}-Systeme ist laut \citeauthor{abts_grundkurs_2017} ein anderes wichtiges Merkmal\cite[vgl.][267]{abts_grundkurs_2017}. 
...
\begin{figure}[h]
    \centering
        \includegraphics[width=8cm]{bis}
        \caption{Die modelltypische Stufen des Business-Intelligence-System}
        \label{fig:bis}
\end{figure}
...
von den operativen Anwendungssystemen getrennt und stellt eine harmonisierte Datenbasis für betriebswirtschaftliche Analysen bereit. Ein \textit{\acrlong{DWH}} bietet eine dauerhafte 
...
In die Kon­zep­ti­o­nie­rung eines \textit{\acrlong{DWH}s} sollten Archivierungskonzepte und Überlegungen zu den Aktualisierungszyklen der Daten für das \textit{\acrshort{DWH}}
...
Im Rahmen herkömmlicher \textit{\acrshort{BI}-Systeme} wird häufig \textit{\acrshort{OLAP}} angewendet. \textit{\acrshort{OLAP}} ist eine Anfragetechnik 
...
Die Präsentation der Daten kann durch Dashboards geschehen. Nach \Citeauthor{few_information_2006} ist ein Dashboard ein \textquote{ ... a visual display of the most important 
