...
modernen Datenvisualisierungen analysiert und ausgewertet werden.
...
Vorkenntnisse der Daten existierten bereits aus früheren Auswertungen mit einem Tabellenkalkulationsprogramm, so dass eine solide Wissensbasis 
der einzelnen Daten bereits bestand. Das bibliothekarischen Domänwissen in Bezug auf das Datenformat der Titeldaten konnte
...
entsprechend angepasst. Leider war dies aufgrund des engen Zeitrahmens des Projekts nicht immer in vollem Umfang möglich. So wurden die Teilsysteme iterativ entwickelt. 
...
Das war allerdings beim praktischen Teil der Arbeit der Fall. Gleichfalls war es das erste große Projekt mit Python und den Bibliotheken pandas, plotly und Dash.
