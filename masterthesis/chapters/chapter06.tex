...
Das datengetriebene Unterstützungssystem, das in dieser Arbeit konzeptionell entworfen und als Proof-of-Concept umgesetzt wurde, erfüllt drei Hauptaufgaben:
...
Jahre 2014 bis 2017 konnten - zwar in einem anderen Format - unproblematisch vom LBS-Team nachgeliefert werden. Um die Daten für den Import passend zu machen, 
musste auch nochmal manuell nachgebessert werden. Problematisch war auch die Datenbasis für die monatlichen Neuerwerbungen. Die Neuerwerbungsdaten wurden 
nur sehr unregelmäßig aus dem CBS in der Vergangenheit abgezogen, so dass dieser Datenbestand viele Lücken aufwies. Leider war es in Verbindung mit den Neuerwerbungen 
...
Kenntnisse der Daten existierten bereits aus früheren Auswertungen mit einem Tabellenkalkulationsprogramm, so dass eine solide Wissensbasis 
der einzelnen Daten bereits bestand. Auch das bibliothekarischen Domänwissen in Bezug auf das Pica-Format der Titeldaten konnte
für die Bestandsdaten zielführend eingesetzt werden. Unbekannte Statistiken wie die \acrlong{COP 5} mussten aufgrund des engen Zeitplans leider unberührt bleiben.
...
so dass für die Transformation in ein einheitliches Dateiformat das Teilsystem 1 entstanden ist.
So war es auch ein Glücksfall, das die pandas Bibliothek viele Funktionen für die verschiedenen Dateiformate anbietet und somit der Import sichergestellt werden konnte.
...
Diese wurden formuliert vor dem Beginn der Entwicklung. Die Re-Evalierung der Anforderungen und der Anwendungsfälle in einem iterativen
Prozess konnte einerseits durch den engen Zeitrahmen des Projektes nicht so gut umgesetzt werden. Andererseits wurden die Teilsysteme nacheinander
entwickelt und erst am Ende des Entwicklungsprozess wurde das Ergebnis in Form des Dashboards sichtbar. Vermutlich wäre es für den Verlauf der Systementwicklung sowie einer
Re-Evaluierung der Anforderungen und Anwendungsfälle besser gewesen, das System ersteinmal mit Daten aus einem bibliothekarischen Bereich aufzubauen.
Danach hätte man das System für die Daten aus den anderen bibliothekarischen Bereichen erweitern können. So hätte man wahrscheinlich eine größere Chance gehabt, Fehler in
...
Im Teilsystem 3 traten so Probleme auf, die durch das Teilsystem 2 verursacht wurden, das auf Grundlage der 
